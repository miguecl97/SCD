...
class ProdCons1SU : public HoareMonitor
{
 ...
 int                        // variables permanentes
   buffer[num_celdas_total*num_productores],//  buffer de tamaño fijo, con los datos
...
{
   cout << "-------------------------------------------------------------------------------" << endl
        << "Problema de los productores-consumidores ("<< num_productores <<" prod /" << num_consumidores << " cons, Monitor SU, buffer LIFO). " << endl
        << "-------------------------------------------------------------------------------" << endl
        << flush ;
