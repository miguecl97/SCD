...
//Otro -1 porque hay un nuevo proceso que es el camarero(no debe contar)
  int solicitud;
  for(int i=0; i<Nveces; i++)
  {
    ...
    cout <<"Filósofo " <<id << " se levanta."<<endl; //(solicita levantarse)
...
void funcion_camarero(){
	...
	for(int i=0;i<Nveces*num_filosofos*2;i++){
