...
// Implementación del ACTIVIDAD 2 de ejecutivo cíclico:
//
//   Datos de las tareas:
//   ------------
//   Ta.  T    C
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         sleep_until( ini_sec );
			...
			cout << "Retraso de: " <<milliseconds_f(fin_sec - ini_sec).count() << " milisegundos ." << endl;
			if( fin_sec - ini_sec > milliseconds(20)){
				cout << "Se ha producido un retraso de mas 20 ms ." << endl;
				return 0;
			}
      }
   }
