...
const int n = 3;   // numero de productores y consumuidores
unsigned  cont_prod[num_items*n] = {0}, // contadores de verificación: producidos
          cont_cons[num_items*n] = {0}; // contadores de verificación: consumidos
...
int n = 3;
thread hebra_productora[n];
thread hebra_consumidora[n];
for(int i = 0 ; i <n ; i++)
{
